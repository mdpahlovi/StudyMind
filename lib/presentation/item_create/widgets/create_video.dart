...
class CreateVideo extends StatefulWidget {
  ...
  @override
  State<CreateVideo> createState() => VideoState();
}

class VideoState extends State<CreateVideo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text('Add Video', style: textTheme.labelLarge),
  ...
  IconData getFileIcon(String extension) {
    switch (extension) {
      ...
      case 'mkv':
      default:
        return HugeIcons.strokeRoundedFileVideo;
    }
  }
}
